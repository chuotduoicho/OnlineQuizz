 ...
 * @author Admin
 */
@WebFilter(filterName = "CheckJspFilter", urlPatterns = {"/*"})
public class CheckJspFilter implements Filter {
    ...
    public CheckJspFilter() {
    }    
    
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("CheckJspFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("CheckJspFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (uri.endsWith("login.jsp")) resp.sendRedirect("login");
            else if (uri.endsWith("makeQuiz.jsp")) resp.sendRedirect("make");
            else if (uri.endsWith("register.jsp")) resp.sendRedirect("register");
            else if (uri.endsWith("takeQuiz.jsp")) resp.sendRedirect("take");
            else if (uri.endsWith("manageQuiz.jsp")) resp.sendRedirect("manage");
            else if (uri.endsWith(".jsp") && !uri.endsWith("error.jsp")) {
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("CheckJspFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("CheckJspFilter()");
        }
        StringBuffer sb = new StringBuffer("CheckJspFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("CheckJspFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("CheckJspFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("CheckJspFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("CheckJspFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("CheckJspFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
